...
const Event: FC<IProps> = ({event}) => {
    ...
    return (
        <div
            className="bg-gray-900 border flex flex-col p-5 rounded-2xl hover:transform hover:scale-105 transition duration-300">
            ...
            <div className="display flex flex-row mt-5 h-[176px] ">
                <div className="flex justify-center items-center"><img
                    className="object-cover object-center border-8 rounded-3xl" width={200} src={image}
                    alt={title}/></div>
                <div className="p-4">
